                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                             <p class="text-subtitle text-muted">View general annoucement regarding your group from your supervisor.</p>
                        </div>
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                       ...
                                       <?php
                                                ...
                                                $sql = "select * FROM message where messid='" . $_SESSION['id'] . "'";
