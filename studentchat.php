...
<body>
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                             <p class="text-subtitle text-muted">View messages from students. Chat with students regarding their projects.</p>
                        </div>
                    ...
                    <div class="row">
                     ...
                     <div class="col-md-6 col-12">
                       <h4>Send Message</h4>
                          ...
                          <form action="suchat.php" method="post">
 ...
 <?php
                                                ...
                                                $conn = mysqli_connect("localhost", "root", "", "projectclass");
                                                $sql = "select * FROM chat,students where chat.chatid = '" . $_SESSION['supid'] . "' and chat.name=students.username";
