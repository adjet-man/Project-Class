                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                             <p class="text-subtitle text-muted"> Send general message to all students .</p>
                        </div>
                    ...
                    <div class="row">
                     ...
                     <div class="col-md-6 col-12">
                       ...
                       <?php if (isset($_GET['error'])) { ?>
                           ...
                           <input hidden type="text" name="messid" value="<?php echo $_SESSION['supid']; ?>">
